...
SUBSCRIPTION_PRICE = float(os.getenv('SUBSCRIPTION_PRICE', '4990.00'))
SUBSCRIPTION_PRICE_SPECIAL = float(os.getenv('SUBSCRIPTION_PRICE_SPECIAL', '4490.00')) 

# Guide pricing
COLOR_GUIDE_PRICE = float(os.getenv('COLOR_GUIDE_PRICE', '500.00'))
KIBBE_GUIDE_PRICE = float(os.getenv('KIBBE_GUIDE_PRICE', '1000.00'))
...
GOOGLE_SHEET_SUBSCRIPTION_WORKSHEET = os.getenv('GOOGLE_SHEET_SUBSCRIPTION_WORKSHEET', 'subscription')
